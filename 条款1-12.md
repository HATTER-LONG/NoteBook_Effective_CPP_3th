...
- [Effective CPP](#effective-cpp)
  ...
  - [构造/析构/赋值运算](#构造析构赋值运算)
    - [条款05：了解 C++ 默默编写并调用了那些函数](#条款05了解-c-默默编写并调用了那些函数)
    ...
    - [条款09：绝不再构造和析构过程中调用 virtual 函数](#条款09绝不再构造和析构过程中调用-virtual-函数)
    - [条款10：令 operator= 返回一个 reference to * this](#条款10令-operator-返回一个-reference-to--this)
    - [条款11：在 operator= 中处理 “自我赋值”](#条款11在-operator-中处理-自我赋值)
    - [条款12：复制对象时勿忘其每一个部分](#条款12复制对象时勿忘其每一个部分)
